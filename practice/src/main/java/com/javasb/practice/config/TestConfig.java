...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    String psswd1 = passwordEncoder.encode("123456");
    String psswd2 = passwordEncoder.encode("123456");
    productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
    User u1 = new User(null, "Maria Brown", "maria@gmail.com", "988888888", psswd1);
    User u2 = new User(null, "Alex Green", "alex@gmail.com", "977777777", psswd2);
